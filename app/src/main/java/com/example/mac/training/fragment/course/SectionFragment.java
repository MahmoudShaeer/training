package com.example.mac.training.fragment.course;
...
import com.example.mac.training.adapter.recyclerAdapter.LectureAdapter;
...
public class SectionFragment extends Fragment {
    ...
    private LectureAdapter coursesAdapter;
    ...
    private void setAdapter() {
        setData();
        coursesAdapter = new LectureAdapter(data);
